...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const userId = 'user_' + Buffer.from(token.slice(-20)).toString('hex').slice(0, 16);
    ...
    return res.status(200).json({ 
      ...
      user: {
        ...
        preferredWineTypes: user.preferred_wine_types ? JSON.parse(user.preferred_wine_types) : null,
