...
const experienceLevels = [
  ...
  {
    value: 'connoisseur',
    label: 'Connoisseur - I have extensive wine knowledge',
  },
];
  ...
  const handleComplete = async () => {
    if (!dateOfBirth || !acceptedTerms || !isValidAge) {
      toast({
        ...
        description:
          "Please complete all required fields and confirm you're 18 or older.",
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      console.log('Submitting profile setup:', {
        ...
        preferredWineTypes:
          selectedWineTypes.length > 0 ? selectedWineTypes : null,
  ...
  const nextStep = () => {
    if (step === 1 && (!dateOfBirth || !acceptedTerms || !isValidAge)) {
      toast({
        ...
        description:
          "Please confirm your date of birth and that you're 18 or older.",
        variant: 'destructive',
      });
      return;
    }
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                cork is an alcohol-related service. You must be 18 or older to
                continue.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                >
                  I confirm that I am 18 years or older and agree to receive
                  wine recommendations and alcohol-related content.
                </Label>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 max-h-80 overflow-y-auto">
              ...
              <div>
                <Label
                  htmlFor="location"
                  className="text-sm font-medium text-slate flex items-center mb-2"
                >
